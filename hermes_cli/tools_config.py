...
CONFIGURABLE_TOOLSETS = [
    ...
    ("kanban",           "🗂️  Kanban Controllers",       "scoped API-server permit controllers"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "kanban", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search"}
